...
public class ToastUtil {
     ...
     * 长时间显示
     */
    public  void longToast(Context context, int id) {
     ...
     * 短时间显示
     */
    public  void shortToast(Context context, int id) {
     ...
     * 短时间显示
     */
    public  void shortToast(Context context, String toast) {
        toast(context.getApplicationContext(), toast, Toast.LENGTH_SHORT);
    }

    public  void shortOrLongToast(Context context, int id, int length) {
        shortOrLongToast(context.getApplicationContext(), context.getApplicationContext().getString(id), length);
    }

    public  void shortOrLongToast(Context context, String res, int length) {
