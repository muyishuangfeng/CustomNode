...
public class TimeFormat {
    ...
    public String getTime() {
        ...
        String dateStr = format(date, mContext.getString(R.string.text_time_format));
        ...
        if (!oldYear.equals(newYear)) {
            ...
            if (oldMonth == newMonth) {
                ...
                if (oldDay == newDay) {
                    ...
                    if (day == 1) {
                        result =  mContext.getString(R.string.text_yestoday);
                    } else if (day == 2) {
                        result = mContext.getString(R.string.text_before);
                    } else if (day > 2 && day < 8) {
                        int week = date.getDay();
                        if (week == 1) {
                            result = mContext.getString(R.string.text_monday);
                        } else if (week == 2) {
                            result = mContext.getString(R.string.text_tuesday);
                        } else if (week == 3) {
                            result = mContext.getString(R.string.text_wednesday);
                        } else if (week == 4) {
                            result = mContext.getString(R.string.text_thursday);
                        } else if (week == 5) {
                            result = mContext.getString(R.string.text_friday);
                        } else if (week == 6) {
                            result = mContext.getString(R.string.text_saturday);
                        } else {
                            result = mContext.getString(R.string.text_sunday);
                        }
                    } else {
        ...
        if (!oldYear.equals(newYear)) {
            ...
            if (oldMonth == newMonth) {
                ...
                if (oldDay == newDay) {
                    ...
                    int day = newDay - oldDay;
                    if (day == 1) {
                        result = mContext.getString(R.string.text_yestoday) + oldHour + ":" + oldMinute;
                    } else if (day == 2) {
                        result = mContext.getString(R.string.text_before) + oldHour + ":" + oldMinute;
                    } else if (day > 2 && day < 8) {
                        int week = date.getDay();
                        if (week == 1) {
                            result = mContext.getString(R.string.text_monday) + " " + oldHour + ":" + oldMinute;
                        } else if (week == 2) {
                            result = mContext.getString(R.string.text_tuesday) + " " + oldHour + ":" + oldMinute;
                        } else if (week == 3) {
                            result = mContext.getString(R.string.text_wednesday) + " " + oldHour + ":" + oldMinute;
                        } else if (week == 4) {
                            result = mContext.getString(R.string.text_thursday) + " " + oldHour + ":" + oldMinute;
                        } else if (week == 5) {
                            result = mContext.getString(R.string.text_friday) + " " + oldHour + ":" + oldMinute;
                        } else if (week == 6) {
                            result = mContext.getString(R.string.text_saturday) + " " + oldHour + ":" + oldMinute;
                        } else {
                            result = mContext.getString(R.string.text_sunday) + " " + oldHour + ":" + oldMinute;
                        }
                    } else {
